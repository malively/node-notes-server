...
module.exports = {
    scripts: {
        ...
        db: {
            ...
            generate: {
                default: 'nps db.generate.migration',

                emptyMigration: {
                  script: runFast('./node_modules/typeorm/cli.js migration:create -n'),

                  description: 'Generate an empty schema migration'
                },

                migration: {
                  script: runFast('./node_modules/typeorm/cli.js migration:generate -n'),

                  description: 'Generate a migration based on current the state of the models'
                },

                entity: {
                  script: runFast('./node_modules/typeorm/cli.js entity:create -n'),

                  description: 'Generate an entity file'
                }
              }
        },
        /**
